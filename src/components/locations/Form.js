...
const ContactUsForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    // Prepare form data to be submitted to FormSubmit.co
    const formDataToSubmit = new FormData(form);

    try {
      // Send the data to FormSubmit
      const response = await fetch('https://formsubmit.co/ajax/silentcosmox@gmail.com', {
        method: 'POST',
    ...
    >
      <div className="max-w-3xl mx-auto px-6">
        ...
        <p className="mt-4 text-lg text-gray-600 text-center">
          We'd love to hear from you! Please fill out the form below, and we'll get back to you as soon as possible. hg
        </p>
